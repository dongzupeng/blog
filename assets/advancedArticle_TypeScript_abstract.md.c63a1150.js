import{_ as s,c as n,o as a,d as l}from"./app.51d770dd.js";const i=JSON.parse('{"title":"\u62BD\u8C61\u7C7Babstract","description":"","frontmatter":{},"headers":[],"relativePath":"advancedArticle/TypeScript/abstract.md"}'),p={name:"advancedArticle/TypeScript/abstract.md"},o=l(`<h1 id="\u62BD\u8C61\u7C7Babstract" tabindex="-1">\u62BD\u8C61\u7C7Babstract <a class="header-anchor" href="#\u62BD\u8C61\u7C7Babstract" aria-hidden="true">#</a></h1><div class="language-ts"><button title="Copy Code" class="copy"></button><span class="lang">ts</span><pre><code><span class="line"><span style="color:#676E95;">//\u62BD\u8C61\u7C7B\u4EE5abstract\u5F00\u5934\u7684\u7C7B\u4E3A\u62BD\u8C61\u7C7B</span></span>
